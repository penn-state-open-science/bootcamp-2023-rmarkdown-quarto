...
2. [Data Analysis and Reporting](https://github.com/gilmore-lab/sex-differences-project)
3. Scientific Reports and Papers
4. [Presentations](https://github.com/penn-state-open-science/bootcamp-2023-rmarkdown-quarto/)
5. Dashboards and [Websites](https://github.com/penn-state-open-science/bootcamp-2023)
6. [Books](https://bookdown.org) and [Manuals](https://databrary.github.io/analytics/weekly.html)
